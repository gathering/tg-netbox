locals {
  device_types = [
    { name = "fiberpatch 2 * 6 par", manufacturer = "Generic", part_number = "", u_height = 1, is_full_depth = false, slug = "fiberpatch_2_x_6_par" },
    { name = "fiberpatch 24 par", manufacturer = "Generic", part_number = "", u_height = 1, is_full_depth = false, slug = "fiberpatch_24_par" },
    { name = "fiberpatch 6 par", manufacturer = "Generic", part_number = "", u_height = 1, is_full_depth = false, slug = "fiberpatch_6_par" }
  ]
  devices = [
    { name = "log-patch", status = "active", site = "Vikingskipet", location = "log", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_2_x_6_par" },
    { name = "noc-to-north-patch", status = "active", site = "Vikingskipet", location = "noc", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_6_par" },
    { name = "noc-to-roof-patch", status = "active", site = "Vikingskipet", location = "noc", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "noc-to-tele-patch", status = "active", site = "Vikingskipet", location = "noc", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "north-patch", status = "active", site = "Vikingskipet", location = "north", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_2_x_6_par" },
    { name = "reception-to-tele-patch", status = "active", site = "Vikingskipet", location = "reception", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_6_par" },
    { name = "roof-north-to-roof-south-patch", status = "active", site = "Vikingskipet", location = "roof-north", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "roof-south-to-roof-north-patch", status = "active", site = "Vikingskipet", location = "roof-south", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "roof-to-noc-patch", status = "active", site = "Vikingskipet", location = "roof-south", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "south-patch", status = "active", site = "Vikingskipet", location = "south", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_2_x_6_par" },
    { name = "stand-to-tele-patch", status = "active", site = "Vikingskipet", location = "stand-altibox", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_6_par" },
    { name = "swing-patch", status = "active", site = "Vikingskipet", location = "swing", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_2_x_6_par" },
    { name = "tele-patch", status = "active", site = "Vikingskipet", location = "tele", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_6_par" },
    { name = "tele-to-noc-patch", status = "active", site = "Vikingskipet", location = "tele", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_24_par" },
    { name = "vrimle-patch", status = "active", site = "Vikingskipet", location = "vrimle", role = "Patch Panel", manufacturer = "Generic", device_type = "fiberpatch_6_par" }
  ]
  rear_ports = [
