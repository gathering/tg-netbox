locals {
  ...
  rear_ports = [
    { name = "G12-1", device = "log-patch", type = "splice", description = "to south", positions = 6 },
    { name = "G12-2", device = "log-patch", type = "splice", description = "to vrimle", positions = 6 },
    { name = "G12-3", device = "log-patch", type = "splice", description = "to south", positions = 6 },
  ...
  front_ports = [
    { name = "port1", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 1, description = "to south" },
    { name = "port2", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 2, description = "to south" },
    { name = "port3", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 3, description = "to south" },
    { name = "port4", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 4, description = "to south" },
    { name = "port5", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 5, description = "to south" },
    { name = "port6", device = "log-patch", type = "sc-upc", rear_port = "G12-1", rear_port_position = 6, description = "to south" },
    { name = "port10", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 1, description = "to vrimle" },
    { name = "port11", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 2, description = "to vrimle" },
    { name = "port12", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 3, description = "to vrimle" },
    { name = "port13", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 4, description = "to vrimle" },
    { name = "port14", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 5, description = "to vrimle" },
    { name = "port15", device = "log-patch", type = "sc-upc", rear_port = "G12-2", rear_port_position = 6, description = "to vrimle" },
    { name = "port19", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 1, description = "to swing" },
    { name = "port20", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 2, description = "to swing" },
    { name = "port21", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 3, description = "to swing" },
    { name = "port22", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 4, description = "to swing" },
    { name = "port23", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 5, description = "to swing" },
    { name = "port24", device = "log-patch", type = "sc-upc", rear_port = "G12-3", rear_port_position = 6, description = "to swing" },
